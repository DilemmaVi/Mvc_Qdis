...
(function ($) {
    ...
    $.validator.setDefaults({
        ...
        onfocusin: function (element, event) {
            ...
            var uidError = $('#username-error');
            var pswError = $('#password-error');
            var uid = $("#username").is(":focus");
            var psw = $("#password").is(":focus");
            if (uid == true)
            {
                uidError.parentsUntil(".tip-yellow").parent().remove();
            }
            if (psw == true) {
                pswError.parentsUntil(".tip-yellow").parent().remove();
            }
